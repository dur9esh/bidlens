  ...
  return (
    <div className="flex-1">
      <main className="max-w-3xl mx-auto px-6 pb-12 space-y-8">
        <PageHeader
          eyebrow="Artifacts · Formal Recommendation"
          title="Evaluation Memo"
          subtitle="The document procurement leadership reads and signs. Generated by the synthesis agent from the complete evaluation record."
        />
  ...
  return (
    <article className="bg-white border border-slate-200 rounded-lg p-10 sm:p-12 shadow-sm">
      <header className="mb-8 pb-6 border-b border-slate-200">
        <h1 className="font-serif text-4xl tracking-tight text-slate-900 mb-3 leading-tight">
          {memo.title}
        </h1>
      ...
      <section className="my-6">
        <div className="bg-slate-50 border-l-4 border-indigo-600 p-4 rounded-r">
          <p className="font-sans text-[11px] font-semibold tracking-[0.18em] text-indigo-700 uppercase mb-1.5">
            Executive summary
          </p>
      ...
      <section className="my-8">
        <h2 className="font-serif text-2xl text-slate-900 mb-3 mt-10">
          Recommendation
        </h2>
        <p className="text-slate-800 leading-relaxed">{memo.recommendation}</p>
        {memo.recommendation_caveats.length > 0 && (
          <div className="mt-4 rounded-md border border-amber-200 bg-amber-50 p-3">
            <p className="font-sans text-[11px] font-semibold tracking-[0.18em] text-amber-800 uppercase mb-2">
              Caveats
            </p>
...
function MemoSectionBlock({ section }: { section: MemoSection }) {
  return (
    <section className="mt-8">
      <h2 className="font-serif text-2xl text-slate-900 mt-10 mb-3">
        {section.heading}
      </h2>
